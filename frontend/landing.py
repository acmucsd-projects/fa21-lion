...
def app():
  ...
  with row1_1:
      st.markdown("Hey there! Welcome to Wanna Turn Into a Cat? ! Simply upload a portrait image of yourself and we will generate a video illustrating your gradual morph into a cat! ")
      st.markdown(
          "**To begin, upload below. ** 👇")
  ...
  if isConfirmed:
    ...
    if success:
      ...
      saveSelected = row2_2.multiselect('Do you want to save this video?', ('Sure!', 'Let me rethink.'))
...
# If User wants to save the video
  if isSaved:
    row2_2.markdown("**You can save your morphed video by logging in.** You can register by going to the Register Page in the Left Menu.")
