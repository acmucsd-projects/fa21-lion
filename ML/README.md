...
A small note from me (Vincent): This project was a very bumpy ride. School work took up a lot of the fall quarter (which sucked but was necessary!). Despite that, I still luckily had the opportunity to dive deeper into the world of GANs (winter break, haha). The AI Team faced a ton of challenges! I remember how difficult it was just refactoring the scripts I wrote for DCGAN, PatchGAN, and CycleGAN. The configuring of the wandb experiment tracking and logging. The agonizingly slow StyleGAN2-ADA training. And the painful task of integrating everything together. I learned a lot, though. And for that, I think this was a huge success. I thank the ACM projects committee for this experience! I would also like to thank my teammate Arth for driving everything forward, Aman for his work in the backend, Gaurav for the frontend, and Edward for the helpful tips and GPU Cluster. And also Justin and Elysia for their contributions to the frontend and everyone who showed up to view our hand-crafted presentation and anyone else who I might've missed (I might be subjected to _cat_-astrophic forgetting)! Thanks everyone for the great experience. I hope to see you all soon!
